...
public class HallwayTest {
    ...
    @Test
    void HelpInHallwayContainsInfoAboutHelpCommand() {
        String hallwayHelp = hallway.getHelp();
        assertThat(hallwayHelp, containsStringIgnoringCase("help"));
    }
    ...
    void InspectingTheSpookyDoorRevealsTheKeypad() {
        ...
        assertThat(commandResult, containsStringIgnoringCase("You see a rugged and sturdy steel door with cryptic symbols on it. Above the door is a sign saying \"EXIT\". "
        		+ "The door is covered in cobweb and next to it is a rusty coin slot. The coin slot has a post-it attached to it saying \"Please insert 3 coins\". You could try to unlock the door with 'insert coins'."));
    }
